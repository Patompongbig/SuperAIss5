...
accelerate launch \
    ...
    script/train_trl_sft_lora.py \
        --output_dir /project/lt-user/uncompile_model/qwen14B \
        --save_strategy "no" \
        --max_seq_length 2048 \
        --num_train_epochs 8 \
        ...
        --model_name_or_path /project/lt-user/pretrained_model/Qwen/Qwen3-14B \
        --train_data /project/lt-user/data/text-to-gloss \
        --bf16 True \
        --deepspeed /project/lt-user/sft_llm/deepspeed_config/deepspeed_3.json \
        --report_to "wandb" \
